$(document).ready(function() {
    let id=JSON.parse(localStorage.getItem("zivotinjaProfilEn"));
    ...
    if(tip == 0) { tip_innerHTML = "Dogs"; tip_href = "psi.html"; }
    else if(tip == 1) { tip_innerHTML = "Cats"; tip_href = "macke.html"; }
    else { tip_innerHTML = "Birds"; tip_href = "ptice.html"; }
